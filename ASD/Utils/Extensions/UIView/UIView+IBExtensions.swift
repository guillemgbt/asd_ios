...
//  MonkingMe
//
//  Created by Guillem Budia Tirado on 23/10/2018.
...
extension UIView {
    ...
    func layoutAttachAll(to view: UIView?, margin : CGFloat = 0.0) {
        ...
        layoutAttachTop(to: v, margin: margin)
        layoutAttachBottom(to: v, margin: margin)
        layoutAttachLeading(to: v, margin: margin)
        layoutAttachTrailing(to: v, margin: margin)
    }
